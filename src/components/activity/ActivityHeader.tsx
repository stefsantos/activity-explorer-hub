  ...
  return (
    <div className="mb-6 relative">
      <Carousel className="w-full">
        ...
        <span className="absolute top-4 left-4 bg-white/80 text-kids-teal text-xs px-3 py-1 rounded-full backdrop-blur-sm font-medium z-10">
          {category}
        </span>
        
        {featured && (
          <span className="absolute top-4 right-16 bg-kids-green text-white text-xs px-3 py-1 rounded-full font-medium z-10">
            Featured
          </span>
        )}
