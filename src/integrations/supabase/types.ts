  ...
  public: {
    Tables: {
      ...
      registered_activities: {
        ...
        Relationships: [
          {
            foreignKeyName: "registered_activities_activity_id_fkey"
            columns: ["activity_id"]
            isOneToOne: false
            referencedRelation: "activities"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "registered_activities_package_id_fkey"
            columns: ["package_id"]
            isOneToOne: false
            referencedRelation: "activity_packages"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "registered_activities_variant_id_fkey"
            columns: ["variant_id"]
            isOneToOne: false
            referencedRelation: "activity_variants"
            referencedColumns: ["id"]
